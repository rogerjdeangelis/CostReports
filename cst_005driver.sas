...
%let gbl_diroto =  0                           ;   * if 1 then build stem cst folder and autocall folder;
%let gbl_dir    =  0                           ;   * if 1 then build all sub folder;
...
*_       _ _
(_)_ __ (_) |_               https://www.dropbox.com/s/ikho1yoevx57zv6/cst_025describe.sas7bdat?dl=0
| | '_ \| | __|
| | | | | | |_
|_|_| |_|_|\__|
;
...
%let gbl_desinp=  https://raw.githubusercontent.com/rogerjdeangelis/CostReports/master/cst_025snfdescribe_b64 /* col des */
...
%utl_b64decode(d:/cst/tmp/cst_025snfdescribe.b64,d:/cst/cst_025snfdescribe.sas7bdat);
...
%utl_b64encode(d:/cst/cst_025describe.sas7bdat,d:/cst/b64/cst_025describe.b64);
