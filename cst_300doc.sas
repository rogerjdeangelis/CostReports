...
*  Running on a $1,000 off lease T7610 with 128gb ram, 16 cores and 32 thread with NVMe drives                  *;
*                                                                                                               *;
*; %let purpose=%str(creat the 2011-2019 excel pufs with 1418 columns ) ;                                       *;
*                                                                                                               *;
